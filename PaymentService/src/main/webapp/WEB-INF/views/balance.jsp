...
<head>
	...
	<title><spring:message code="label.titleBalance" /></title>
    ...
    <div class="header-top">
     ...
     <div class="header-bottom" id="tour">
		 ...
		 <div class = "contentholder">
		 	<div class = "balance">
		 		<h1><spring:message code="label.userGreetings" /><span>${username} .</span></h1>
				<h2><spring:message code="label.userBalance" /><span>${balance} .</span></h2>
		 	</div>		 
		 </div>
		 </div>
	</div>
